 ...
 *
 ...
 gcc -g -Wall  httpserver.c array.c myregex.c regex.c filetypes.c dict.c files.c mystring.c urlcode.c base64.c -lpthread -lwsock32 -lm -D STDC_HEADERS -D DEBUG -D debug_httpserver && a
 gdb ~/a
...
void Client_respond(Client*client)
{
	...
	if( strcmp(client->real_path,"/sdcard/tmpshot.png") == 0)
		...
		system("screenshot");
#else
	if( strcmp(client->real_path,"/home/libiao/tmpshot.png") == 0) {
		system("scrot /home/libiao/tmpshot.png");
